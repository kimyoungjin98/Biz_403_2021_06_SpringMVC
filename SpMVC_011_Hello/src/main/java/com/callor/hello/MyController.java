...
public class MyController {
	 ...
	 * 
	 * RESTfull HHTP Server에서 추가하여 사용
	 * 		PUT : 업데이트(UPDATE)
	 * 		DELETE : 삭제(DELETE)
	 * 
	 ...
	 * 전달받은 변수이름과 Java method 매개변수와 이름매칭방법으로 
	 * 변수를 받는다
	 * 이런 코드는 개발자가 신경쓰지 않아도 자동으로 작동되는 코드이다
	 * getParameter() 등의 코드를 이제는 잊어도 된다
	 * 
	 * 그런데,
	 * Java method의 변수를 String형이 아닌것으로 
	 * 		숫자형, Boolean형 등 
	 ...
	 * 		Reflection 코드가 중단되고 
	 * 		Spring의 Dispatcher는 Web 400 status code를 응답한다 
	 * 		실행된다 
	 * 
	 * 		또한 구체적인 어떠한 문제가 발생했는지 알려주지 않는다
	 */
